...
export function HeroSection() {
  return (
    <section className="relative pt-24 pb-12 sm:pt-28 sm:pb-16 md:pt-36 md:pb-24 grid-bg overflow-hidden">
      {/* Subtle radial glow */}
      <div
        className="pointer-events-none absolute inset-0"
        aria-hidden="true"
      >
        <div className="absolute left-1/2 top-0 -translate-x-1/2 h-[320px] sm:h-[480px] w-[480px] sm:w-[680px] rounded-full bg-accent/5 blur-3xl" />
      </div>
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="max-w-xl">
            <div className="inline-flex items-center gap-2 rounded-full border border-border bg-surface px-3 py-1 text-xs text-muted mb-5 sm:mb-6">
              <span className="h-1.5 w-1.5 rounded-full bg-status-ok animate-pulse" />
              v{siteConfig.release.version} released
            </div>

            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground leading-[1.1] mb-5 sm:mb-6">
              System monitoring.{" "}
            ...
            <p className="text-base sm:text-lg text-muted leading-relaxed mb-6 sm:mb-8 max-w-lg">
